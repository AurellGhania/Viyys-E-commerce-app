...
class _CategoriesState extends State<Categories> {
  ...
  GestureDetector _buildCategory(int index) {
    ...
    return GestureDetector( //gesture detector itu kayak buat deteksi pergerakan menggunakan pen, tapi bisa juga tidak menggunakan pen, (mendeteksi pergrakan)
      ...
      child: Padding(
        padding:  EdgeInsets.symmetric(horizontal: dafultPadding), // Mengatur padding horizontal
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                ? (themeProvider.isDarkTheme ? Colors.white : primaryColor)
                 : (themeProvider.isDarkTheme ? Colors.grey : secondaryColor), // Warna berdasarkan kondisi
            ...
            Container(
              ...
              color: selectedIndex == index ? (themeProvider.isDarkTheme ? Colors.white : primaryColor)
                 : (themeProvider.isDarkTheme ? Colors.grey : secondaryColor) // Garis hanya muncul di item yang dipilih
            ),
          ],
        ),
      ),
